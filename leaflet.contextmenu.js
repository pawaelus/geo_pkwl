...
(function (t) {
	...
	t.Map.ContextMenu = t.Handler.extend({
			...
			addHooks : function () {
				...
				t.DomEvent.on(this._map.getContainer(), "mouseleave", this._hide, this)
			},
			removeHooks : function () {
				...
				t.DomEvent.off(this._map.getContainer(), "mouseleave", this._hide, this)
			},
			showAt : function (e, n) {
			...
			setDisabled : function (e, n) {
				...
				o = t.Map.ContextMenu.BASE_CLS + "-item";
				if (!isNaN(e)) {
					e = i.children[e]
				}
			...
			_createItems : function () {
				var t = this._map.options.contextmenuItems,
				e,
				n,
				i;
			...
			_createItem : function (e, n, i) {
				...
				var o = t.Map.ContextMenu.BASE_CLS + "-item",
				s = n.disabled ? o + " " + o + "-disabled" : o,
				h = this._insertElementAt("a", s, e, i),
				a = this._createEventHandler(h, n.callback, n.context, n.hideOnSelect),
				m = "";
				if (n.icon) {
			...
			_createEventHandler : function (e, n, i, o) {
				var s = this,
				h = this._map,
				a = t.Map.ContextMenu.BASE_CLS + "-item-disabled",
				o = o !== undefined ? o : true;
				return function (m) {
					...
					s._map.fire("contextmenu:select", {
						contextmenu : s,
						el : e
					})
				}
			...
			_showAtPoint : function (e, n) {
				if (this._items.length) {
					var i = this._map,
					o = i.containerPointToLayerPoint(e),
					s = i.layerPointToLatLng(o),
					h = {
						contextmenu : this
					};
					if (n) {
	...
	t.Mixin.ContextMenu = {
		...
		_showContextMenu : function (t) {
			...
			if (this._map.contextmenu) {
				...
				this._map.contextmenu.showAt(n, {
					relatedTarget : this
				})
			}
		},
