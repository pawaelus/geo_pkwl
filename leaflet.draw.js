...
! function(t, e) {
    L.drawVersion = "0.2.4-dev", L.drawLocal = {
        draw: {
            ...
            handlers: {
                ...
                polyline: {
                    ...
                    tooltip: {
                        start: "Kliknij aby zacząć pomiar",
                        cont: "Kliknij aby kontynuować pomiar.",
                        end: "Kliknij aby zakończyć pomiar."
                    }
                },
                rectangle: {
                    tooltip: {
        ...
        _enableLayerEdit: function(t) {
            ...
            (!o || i._icon) && (this._backupLayer(i), this._selectedPathOptions && (e = L.Util.extend({}, this._selectedPathOptions), e.maintainColor && (e.color = i.options.color, e.fillColor = i.options.fillColor), o ? this._toggleMarkerHighlight(i) : (i.options.previousOptions = L.Util.extend({
                dashArray: null
